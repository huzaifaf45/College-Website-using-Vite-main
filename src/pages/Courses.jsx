...
const Courses = () => {
  return (
    <>
     <Breadcrumb title="Courses Offered" />
      <section className="course">
        <h1>Courses Offered</h1>
        <p>
          The courses are offered in the streams of Engineering and
          Architecture, Management and Business administration, Science, Arts,
